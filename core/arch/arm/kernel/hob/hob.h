...
extern TEE_Result create_resource_descriptor_hob(
...
extern TEE_Result create_guid_hob(struct efi_hob_handoff_info_table *hob_table,
		TEE_UUID *guid, uint16_t data_length, void **data);

extern TEE_Result create_fv_hob(struct efi_hob_handoff_info_table *hob_table,
